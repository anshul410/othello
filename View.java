...
public class View extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        logoPanel.setBackground(new java.awt.Color(228, 226, 240));

        logoLabel.setBackground(new java.awt.Color(226, 228, 240));
    ...
    public void update(GameState gameState) {
		...
		blackLogoLabel.setIcon(new ImageIcon(getClass().getResource("./images/black_circle.gif")));
		whiteLogoLabel.setIcon(new ImageIcon(getClass().getResource("./images/white_circle.gif")));
		if(gameState.getNextPlayer() == 'B') {
			nextPlayerLabel.setIcon(new ImageIcon(getClass().getResource("./images/black_circle.gif")));
		} else if(gameState.getNextPlayer() == 'W') {
			nextPlayerLabel.setIcon(new ImageIcon(getClass().getResource("./images/white_circle.gif")));
		}	  
...
class ImageRenderer extends DefaultTableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, 
      ...
      if(board[row][column - 1] == 'B') {
          label.setIcon(new ImageIcon(getClass().getResource("./images/black.gif")));
      } else if(board[row][column - 1] == 'W') {
	      label.setIcon(new ImageIcon(getClass().getResource("./images/white.gif")));
	  }	  
      return label;
  }
}
